...
| Dependencies | Step 05 gate PASS; worktree `/Volumes/Work/swarmery-wt-frontend` (work in `tools/swormery`) |
...
Fresh Claude Code session in `/Volumes/Work/swarmery-wt-frontend/tools/swormery` (worktree, branch
`feat/swormery-frontend`). Playwright available for screenshots.
...
Context:
Репозиторій Swormery після T1. Працюєш у гілці feat/swormery-frontend, ТІЛЬКИ в web/.
...
Дизайн екранів: swormery-design.md §3.1 (Overview) і §3.3 (Sessions).
...
РЕФЕРЕНС ДИЗАЙНУ — docs/design/swormery-ui-mockup.html: відтвори цю мову
...
видна; поклади їх у web/screenshots/. Conventional commits у feat/swormery-frontend.
Заповни Completion Report у docs/plan/step-07-agent-b-frontend.md (worktree).
```

## Detailed Instructions

- The mockup (`docs/design/swormery-ui-mockup.html`) also shows Approvals and Agents
