...
`swormery-design.md` §2 **now**, while fixing it costs one doc edit instead of a
...
Context: репозиторій Swormery після spike (step 02). Це механічна частина
...
4. Звір мапінг-таблицю в docs/jsonl-format.md проти DDL у swormery-design.md §2:
...
3. If the mapping diverges from `swormery-design.md` §2 — **edit the design doc now**
