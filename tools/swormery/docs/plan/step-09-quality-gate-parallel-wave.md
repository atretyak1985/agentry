...
Context: три worktrees завершили роботу (feat/swormery-ingest, feat/swormery-frontend,
feat/swormery-metrics). Це механічна частина gate; UX-рішення приймає людина.
